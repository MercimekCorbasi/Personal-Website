...
const items = [
    { icon: 'fab fa-discord', link: 'https://discord.com/users/713843207049314346' },
    { icon: 'fab fa-instagram', link: 'https://instagram.com/alikartalm' },
  ]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">Meco</p>
